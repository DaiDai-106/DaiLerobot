...
class RobotConfig:
    ...
    calibration_dir: Path | None = None # 标定文件路径
    ...
    # # cameras
    # cameras: dict[str, CameraConfig] = field(default_factory=dict)  暂时还没有加入相机，如果有相机后，这里需要回填一下相机配置
...
class Robot:
    ...
    def calibrate(self) -> None:
        ...
        full_turn_motor = "wrist_roll" # 我这里肯定是全都要进行的
